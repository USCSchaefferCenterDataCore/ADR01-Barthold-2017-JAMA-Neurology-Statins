...
outreg2 using "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Programs/Analysis/statins_survival18b.xls", cttop(setup) replace
//outsum statin_user using "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Programs/Analysis/statins_survival18bds.xls", ctitle(setup) replace
...
foreach i in `stats'{
	foreach j in `days'{
			...
			//outsum ever_adv ever_ad ad_inc_ver days_all days_all_ev ageD_min female race_dw race_db race_dh hcc_comm_min hyper_min naddem_b09 if postStat==1 using "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Programs/Analysis/statins_survival18bds.xls", ctitle(treated `i' `j' days) append
			//outsum ever_adv ever_ad ad_inc_ver days_all days_all_ev ageD_min female race_dw race_db race_dh hcc_comm_min hyper_min naddem_b09 if postStat==0 using "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Programs/Analysis/statins_survival18bds.xls", ctitle(control `i' `j' days) append
			...
			outreg2 using "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Programs/Analysis/statins_survival18b.xls", cttop(`i' `j') cttop(all) append
			...
			outreg2 using "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Programs/Analysis/statins_survival18b.xls", cttop(`i' `j') cttop(female) append
			estat phtest, rank detail
			...
			outreg2 using "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Programs/Analysis/statins_survival18b.xls", cttop(`i' `j') cttop(male) append
			estat phtest, rank detail
			...
			outreg2 using "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Programs/Analysis/statins_survival18b.xls", cttop(`i' `j') cttop(white) append
			estat phtest, rank detail
			...
			outreg2 using "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Programs/Analysis/statins_survival18b.xls", cttop(`i' `j') cttop(white female) append
			estat phtest, rank detail
			...
			outreg2 using "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Programs/Analysis/statins_survival18b.xls", cttop(`i' `j') cttop(white male) append
			estat phtest, rank detail
			...
			outreg2 using "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Programs/Analysis/statins_survival18b.xls", cttop(`i' `j') cttop(hispanic) append
			estat phtest, rank detail
			...
			outreg2 using "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Programs/Analysis/statins_survival18b.xls", cttop(`i' `j') cttop(hispanic female) append
			estat phtest, rank detail
			...
			outreg2 using "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Programs/Analysis/statins_survival18b.xls", cttop(`i' `j') cttop(hispanic male) append
			estat phtest, rank detail
			...
			outreg2 using "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Programs/Analysis/statins_survival18b.xls", cttop(`i' `j') cttop(black) append
			estat phtest, rank detail
			...
			outreg2 using "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Programs/Analysis/statins_survival18b.xls", cttop(`i' `j') cttop(black female) append
			estat phtest, rank detail
			...
			outreg2 using "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Programs/Analysis/statins_survival18b.xls", cttop(`i' `j') cttop(black male) append
			estat phtest, rank detail
	}
}
