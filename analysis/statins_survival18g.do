...
outreg2 using "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Programs/Analysis/statins_survival18g.xls", cttop(setup) replace
//outsum statin_user using "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Programs/Analysis/statins_survival18gds.xls", ctitle(setup) replace
...
foreach i in `stats'{
	foreach j in `days'{
			...
			keep if ach1d_`i'==1 | statin_user==0
			keep if days_`i'_2006>=`j' | days_`i'_2007>=`j' | days_`i'_2008>=`j' | statin_user==0
			
			gen treat = 0				
			replace treat = 1 if days_`i'_2006>=`j' & statin_user==1 			//mark everyone who has achieved j in some number of 6 7 8 as treated
			replace treat = 1 if days_`i'_2007>=`j' & statin_user==1 						 		//mark everyone who has achieved j in some number of 6 7 8 as treated
			replace treat = 1 if days_`i'_2008>=`j' & statin_user==1  								//mark everyone who has achieved j in some number of 6 7 8 as treated
			...
			//outsum ever_adv ever_ad ad_inc_ver days_all days_all_ev ageD_min female race_dw race_db race_dh hcc_comm_min hyper_min naddem_b09 if postStat==1 using "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Programs/Analysis/statins_survival18gds.xls", ctitle(treated `i' `j' days) append
			//outsum ever_adv ever_ad ad_inc_ver days_all days_all_ev ageD_min female race_dw race_db race_dh hcc_comm_min hyper_min naddem_b09 if postStat==0 using "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Programs/Analysis/statins_survival18gds.xls", ctitle(control `i' `j' days) append
			...
			outreg2 using "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Programs/Analysis/statins_survival18g.xls", cttop(`i' `j') cttop(all) append
			...
			outreg2 using "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Programs/Analysis/statins_survival18g.xls", cttop(`i' `j') cttop(female) append
			estat phtest, rank detail
			...
			outreg2 using "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Programs/Analysis/statins_survival18g.xls", cttop(`i' `j') cttop(male) append
			estat phtest, rank detail
			...
			outreg2 using "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Programs/Analysis/statins_survival18g.xls", cttop(`i' `j') cttop(white) append
			estat phtest, rank detail
			...
			outreg2 using "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Programs/Analysis/statins_survival18g.xls", cttop(`i' `j') cttop(white female) append
			estat phtest, rank detail
			...
			outreg2 using "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Programs/Analysis/statins_survival18g.xls", cttop(`i' `j') cttop(white male) append
			estat phtest, rank detail
			...
			outreg2 using "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Programs/Analysis/statins_survival18g.xls", cttop(`i' `j') cttop(hispanic) append
			estat phtest, rank detail
			...
			outreg2 using "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Programs/Analysis/statins_survival18g.xls", cttop(`i' `j') cttop(hispanic female) append
			estat phtest, rank detail
			...
			outreg2 using "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Programs/Analysis/statins_survival18g.xls", cttop(`i' `j') cttop(hispanic male) append
			estat phtest, rank detail
			...
			outreg2 using "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Programs/Analysis/statins_survival18g.xls", cttop(`i' `j') cttop(black) append
			estat phtest, rank detail
			...
			outreg2 using "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Programs/Analysis/statins_survival18g.xls", cttop(`i' `j') cttop(black female) append
			estat phtest, rank detail
			...
			outreg2 using "/disk/agedisk3/medicare.work/goldman-DUA25731/PROJECTS/AD-Statins/Programs/Analysis/statins_survival18g.xls", cttop(`i' `j') cttop(black male) append
			estat phtest, rank detail
	}
}
